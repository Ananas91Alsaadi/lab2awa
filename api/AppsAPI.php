...
class AppsAPI extends RestAPI
{
    ...
    {
        $apps = AppsService::getAppById($id);
    ...
    private function postOne()
    {
        ...
        $apps->app_name = $this->body["app_name"];
        $apps->description = $this->body["description"];
        $apps->price = $this->body["price"];

        $success = AppsService::saveApp($apps);
    ...
    private function putOne($id)
    {
        ...
        $success = AppsService::updateAppById($id, $apps);
