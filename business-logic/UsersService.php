...
class UsersService{
    ...
    public static function getUserById($id){
        ...
        $users = $users_database->getOne($id);
    ...
    public static function saveUser(UsersModel $users){
        $users_database = new UsersDatabase();
        ...
        $users = $users_database->insert($users);
    ...
    public static function updateUserById($user_id, UsersModel $users){
        $users_database = new UsersDatabase();
        ...
        $success = $users_database->updateById($user_id, $users);
